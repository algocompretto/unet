...
class ConfusionMatrix(object):
    ...
    def update(self, a, b):
        ...
        with torch.no_grad():
            # Find the pixel index of the target in GT
            k = (a >= 0) & (a < n)
            # Count the number of pixels that the real category a[k] is predicted to be the category b[k] (the approach here is very clever)
    ...
    def compute(self):
        ...
        # Calculate the IoU of each category prediction and the true target
